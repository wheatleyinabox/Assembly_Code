...
#N: 	
	.word 5 # loop count
#X: 	
	.word 2, 4, 6, 8, 10 # array of numbers to be added'
#SUM: 	
	.word 0 # location of the final sum
#str:
...
#loop: 	
	...
	add $a0,$s1,$zero # moving the result to a1 where syscall can see it
	syscall # this prints the result
